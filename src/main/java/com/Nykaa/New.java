...
public class New {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.switchTo().window(wh.get(1)); // Switch to the new window
        driver.get(driver.getCurrentUrl()); // Refresh the page
        Thread.sleep(8000);
        ...
        driver.switchTo().window(wh1.get(2)); // Switch to the new window
        driver.get(driver.getCurrentUrl()); // Refresh the page
